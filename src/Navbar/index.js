...
const Navbar = () => {
    ...
    return (
        <motion.div className={`navbar ${theme}`} initial={{y:"-10vh", opacity:1}} animate={{y:0, opacity:1}}>
            <div className="container">
                <motion.div whileHover={{scale: 1.15,transition: { duration: 0.1 }}} className="logo">
                    <Link to="/">
                ...
                <motion.div className={`links ${menu === "closed" ? "closeMenu" : "openMenu"}`}>
                    <motion.div whileHover={{scale: 1.15,transition: { duration: 0.1 }}}><NavLink to="/about" className="Link" onClick={() => setMenu("closed")}>About Me</NavLink></motion.div>
                    <motion.div whileHover={{scale: 1.15,transition: { duration: 0.1 }}}><NavLink to="/projects" className="Link" onClick={() => setMenu("closed")}>Projects</NavLink></motion.div>
                    <motion.div whileHover={{scale: 1.15,transition: { duration: 0.1 }}}><NavLink to="/blogs" className="Link" onClick={() => setMenu("closed")}>Blogs</NavLink></motion.div>
                    <motion.div whileHover={{scale: 1.15,transition: { duration: 0.1 }}}><NavLink to="/contact" className="Link" onClick={() => setMenu("closed")}>Contact Me</NavLink></motion.div>
                </motion.div>
                <div className="right">
